...
\lstinputlisting[language=C++]{seq/dijkstra.h}
\lstinputlisting[language=C++]{seq/dijkstra.cpp}
\lstinputlisting[language=C++]{seq/main.cpp}

\subsection*{OpenMP}
\lstinputlisting[language=C++]{omp/dijkstra.h}
\lstinputlisting[language=C++]{omp/dijkstra.cpp}
\lstinputlisting[language=C++]{omp/main.cpp}

\subsection*{TBB}
\lstinputlisting[language=C++]{tbb/dijkstra.h}
\lstinputlisting[language=C++]{tbb/dijkstra.cpp}
\lstinputlisting[language=C++]{tbb/main.cpp}

\subsection*{std::threads}
\lstinputlisting[language=C++]{std/dijkstra.h}
\lstinputlisting[language=C++]{std/dijkstra.cpp}
\lstinputlisting[language=C++]{std/main.cpp}
